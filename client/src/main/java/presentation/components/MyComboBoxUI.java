...
//				sp.setBorder(null);
		...
		((BasicComboPopup) popup).setBorder(BorderFactory.createEmptyBorder());
//		((BasicComboPopup) popup).setPopupSize(20, 10);
//		Dimension d = new Dimension(((BasicComboPopup) popup).getWidth()-10, ((BasicComboPopup) popup).getHeight());
//		((BasicComboPopup) popup).setPreferredSize(d);
		return popup;
	}
...
//			System.out.println("my focus gained");
			...
			comboBox.setBorder(new LineBorder(ColorPallet.GrayDark, 2));
//			comboBox.repaint();
//			theEditor.repaint();
		}
...
//			System.out.println("my focus lost");
			...
			theEditor.setHorizontalAlignment(JTextField.CENTER);
			theEditor.setBackground(Color.white);
			comboBox.setBorder(new LineBorder(ColorPallet.GrayLight, 1));
		}
